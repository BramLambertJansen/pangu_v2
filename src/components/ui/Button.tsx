...
const variantStyles: Record<Variant, string> = {
  ...
  secondary: 'bg-[var(--surface-2)] text-[var(--ink)] hover:bg-[var(--surface-3)] focus-visible:ring-[var(--violet)]',
  ghost:     'bg-transparent text-[var(--muted)] hover:bg-[var(--surface-hover)] hover:text-[var(--ink-soft)] focus-visible:ring-[var(--violet)]',
  danger:    'bg-[var(--crimson)] text-white hover:opacity-90 focus-visible:ring-[var(--crimson)]',
}
