...
import { useCharacter, useUpdateCharacterHp, useToggleCharacterInspiration, useUpdateCharacterDeathSaves, useUpdateCharacterSpellSlot, useToggleCharacterCondition, useUpdateCharacterClassResource, useUpdateCharacterTempHp, useCharacterLongRest, useReturnItemToDm } from '@/hooks/queries/useCharacter'
...
export default function CharacterDetailPage() {
  ...
  const returnItemToDm = useReturnItemToDm(id!)
  const { data: character, isLoading } = useCharacter(id)
  const updateHp = useUpdateCharacterHp(id!)
  const toggleInspiration = useToggleCharacterInspiration(id!)
  const updateDeathSaves = useUpdateCharacterDeathSaves(id!)
  const updateSpellSlot = useUpdateCharacterSpellSlot(id!)
  const toggleCondition = useToggleCharacterCondition(id!)
  const updateClassResource = useUpdateCharacterClassResource(id!)
