    ...
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
      <div style={{ maxWidth: 820, width: '100%' }}>
        <Breadcrumbs
          showBack
          onBack={handleBack}
          items={[{ label: encounterData.name, to: `/encounters/${id}` }]}
          current="Bewerken"
        />
                ...
                {filteredBestiaries.length === 0 ? (
                  ...
                  filteredBestiaries.map((b) => (
                    <button
                      ...
                      onMouseEnter={(e) => (e.currentTarget.style.background = 'rgb(var(--crimson-rgb) / 0.06)')}
      ...
      >
        ...
        <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          ...
          <Button variant="danger" onClick={handleDelete} disabled={deleteEncounter.isPending}>
